...
Hardware-aware: tunes parallel/batch_size to host (override via
KOSHA_EMBED_PARALLEL / KOSHA_EMBED_BATCH).
...
*Embed a list of code chunks using emb_fn, batched to bound peak
memory.*
...
def process_repo(
    content:NoneType=None, reembed:bool=False
):
